...
class TestIntegration:
    ...
    def test_integration_authentication_invalid(self, client):
        """
    ...
    def test_integration_book_invalid_date(self, client):
        """
    ...
    def test_integration_purchase_point_limit(self, client):
        """
        Test that booking a competition with an invalid date (past competition) displays an error message
        :param client:
        :param mock_clubs:
    ...
    def test_integration_purchase_places_limit(self, client, mock_places_limit):
        """
    ...
    def test_integration_purchase_insufficient_spots(self, client):
        """
    ...
    def test_integration_show_clubs_empty(self, client, mock_invalid_clubs):
        """
